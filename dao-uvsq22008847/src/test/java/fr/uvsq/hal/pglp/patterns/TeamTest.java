...
class TeamTest {
  ...
  @Test   
  public void uneEquipelEstSerializable() throws IOException, ClassNotFoundException {
    byte[] frodonAsByteArray = SerializationUtils.serialize(frodon);
    Team deserializedFrodon = SerializationUtils.deserialize(frodonAsByteArray, Team.class);
